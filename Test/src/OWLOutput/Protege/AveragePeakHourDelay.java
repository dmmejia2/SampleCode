 ...
 * Source Class: AveragePeakHourDelay <br>
 * @version generated on Mon Mar 06 21:12:30 MST 2017 by danielmejia
 */

public interface AveragePeakHourDelay extends WrappedIndividual {
    ...
    /* ***************************************************
     * Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasAveragePeakHourDelay.AveragePeakYear
     */
     
    /**
     * Gets all property values for the hasAveragePeakHourDelay.AveragePeakYear property.<p>
     * 
     * @returns a collection of values for the hasAveragePeakHourDelay.AveragePeakYear property.
     */
    Collection<? extends Integer> getHasAveragePeakHourDelay.AveragePeakYear();

    /**
     * Checks if the class has a hasAveragePeakHourDelay.AveragePeakYear property value.<p>
     * 
     * @return true if there is a hasAveragePeakHourDelay.AveragePeakYear property value.
     */
    boolean hasHasAveragePeakHourDelay.AveragePeakYear();

    /**
     * Adds a hasAveragePeakHourDelay.AveragePeakYear property value.<p>
     * 
     * @param newHasAveragePeakHourDelay.AveragePeakYear the hasAveragePeakHourDelay.AveragePeakYear property value to be added
     */
    void addHasAveragePeakHourDelay.AveragePeakYear(Integer newHasAveragePeakHourDelay.AveragePeakYear);

    /**
     * Removes a hasAveragePeakHourDelay.AveragePeakYear property value.<p>
     * 
     * @param oldHasAveragePeakHourDelay.AveragePeakYear the hasAveragePeakHourDelay.AveragePeakYear property value to be removed.
     */
    void removeHasAveragePeakHourDelay.AveragePeakYear(Integer oldHasAveragePeakHourDelay.AveragePeakYear);



    /* ***************************************************
     * Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasAveragePeakHourDelay.id
     */
     
    /**
     * Gets all property values for the hasAveragePeakHourDelay.id property.<p>
     * 
     * @returns a collection of values for the hasAveragePeakHourDelay.id property.
     */
    Collection<? extends Integer> getHasAveragePeakHourDelay.id();

    /**
     * Checks if the class has a hasAveragePeakHourDelay.id property value.<p>
     * 
     * @return true if there is a hasAveragePeakHourDelay.id property value.
     */
    boolean hasHasAveragePeakHourDelay.id();

    /**
     * Adds a hasAveragePeakHourDelay.id property value.<p>
     * 
     * @param newHasAveragePeakHourDelay.id the hasAveragePeakHourDelay.id property value to be added
     */
    void addHasAveragePeakHourDelay.id(Integer newHasAveragePeakHourDelay.id);

    /**
     * Removes a hasAveragePeakHourDelay.id property value.<p>
     * 
     * @param oldHasAveragePeakHourDelay.id the hasAveragePeakHourDelay.id property value to be removed.
     */
    void removeHasAveragePeakHourDelay.id(Integer oldHasAveragePeakHourDelay.id);
