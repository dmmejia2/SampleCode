 ...
 * Source Class: AverageResponseTime <br>
 * @version generated on Mon Mar 06 21:12:30 MST 2017 by danielmejia
 */

public interface AverageResponseTime extends WrappedIndividual {

    /* ***************************************************
     * Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasAverageResponseTime.AverageValue
     */
     
    /**
     * Gets all property values for the hasAverageResponseTime.AverageValue property.<p>
     * 
     * @returns a collection of values for the hasAverageResponseTime.AverageValue property.
     */
    Collection<? extends Object> getHasAverageResponseTime.AverageValue();

    /**
     * Checks if the class has a hasAverageResponseTime.AverageValue property value.<p>
     * 
     * @return true if there is a hasAverageResponseTime.AverageValue property value.
     */
    boolean hasHasAverageResponseTime.AverageValue();

    /**
     * Adds a hasAverageResponseTime.AverageValue property value.<p>
     * 
     * @param newHasAverageResponseTime.AverageValue the hasAverageResponseTime.AverageValue property value to be added
     */
    void addHasAverageResponseTime.AverageValue(Object newHasAverageResponseTime.AverageValue);

    /**
     * Removes a hasAverageResponseTime.AverageValue property value.<p>
     * 
     * @param oldHasAverageResponseTime.AverageValue the hasAverageResponseTime.AverageValue property value to be removed.
     */
    void removeHasAverageResponseTime.AverageValue(Object oldHasAverageResponseTime.AverageValue);



    /* ***************************************************
     * Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasAverageResponseTime.Unit
     */
     
    /**
     * Gets all property values for the hasAverageResponseTime.Unit property.<p>
     * 
     * @returns a collection of values for the hasAverageResponseTime.Unit property.
     */
    Collection<? extends XMLGregorianCalendar> getHasAverageResponseTime.Unit();

    /**
     * Checks if the class has a hasAverageResponseTime.Unit property value.<p>
     * 
     * @return true if there is a hasAverageResponseTime.Unit property value.
     */
    boolean hasHasAverageResponseTime.Unit();

    /**
     * Adds a hasAverageResponseTime.Unit property value.<p>
     * 
     * @param newHasAverageResponseTime.Unit the hasAverageResponseTime.Unit property value to be added
     */
    void addHasAverageResponseTime.Unit(XMLGregorianCalendar newHasAverageResponseTime.Unit);

    /**
     * Removes a hasAverageResponseTime.Unit property value.<p>
     * 
     * @param oldHasAverageResponseTime.Unit the hasAverageResponseTime.Unit property value to be removed.
     */
    void removeHasAverageResponseTime.Unit(XMLGregorianCalendar oldHasAverageResponseTime.Unit);



    /* ***************************************************
     * Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasAverageResponseTime.Year
     */
     
    /**
     * Gets all property values for the hasAverageResponseTime.Year property.<p>
     * 
     * @returns a collection of values for the hasAverageResponseTime.Year property.
     */
    Collection<? extends Integer> getHasAverageResponseTime.Year();

    /**
     * Checks if the class has a hasAverageResponseTime.Year property value.<p>
     * 
     * @return true if there is a hasAverageResponseTime.Year property value.
     */
    boolean hasHasAverageResponseTime.Year();

    /**
     * Adds a hasAverageResponseTime.Year property value.<p>
     * 
     * @param newHasAverageResponseTime.Year the hasAverageResponseTime.Year property value to be added
     */
    void addHasAverageResponseTime.Year(Integer newHasAverageResponseTime.Year);

    /**
     * Removes a hasAverageResponseTime.Year property value.<p>
     * 
     * @param oldHasAverageResponseTime.Year the hasAverageResponseTime.Year property value to be removed.
     */
    void removeHasAverageResponseTime.Year(Integer oldHasAverageResponseTime.Year);



    /* ***************************************************
     * Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasAverageResponseTime.id
     */
     
    /**
     * Gets all property values for the hasAverageResponseTime.id property.<p>
     * 
     * @returns a collection of values for the hasAverageResponseTime.id property.
     */
    Collection<? extends Integer> getHasAverageResponseTime.id();

    /**
     * Checks if the class has a hasAverageResponseTime.id property value.<p>
     * 
     * @return true if there is a hasAverageResponseTime.id property value.
     */
    boolean hasHasAverageResponseTime.id();

    /**
     * Adds a hasAverageResponseTime.id property value.<p>
     * 
     * @param newHasAverageResponseTime.id the hasAverageResponseTime.id property value to be added
     */
    void addHasAverageResponseTime.id(Integer newHasAverageResponseTime.id);

    /**
     * Removes a hasAverageResponseTime.id property value.<p>
     * 
     * @param oldHasAverageResponseTime.id the hasAverageResponseTime.id property value to be removed.
     */
    void removeHasAverageResponseTime.id(Integer oldHasAverageResponseTime.id);
