 ...
 * Source Class: BridgeOfTheAmericasAverageWaitingTime <br>
 * @version generated on Mon Mar 06 21:12:30 MST 2017 by danielmejia
 */

public interface BridgeOfTheAmericasAverageWaitingTime extends WrappedIndividual {
    ...
    /* ***************************************************
     * Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasPOEAmericasBridge.id
     */
     
    /**
     * Gets all property values for the hasPOEAmericasBridge.id property.<p>
     * 
     * @returns a collection of values for the hasPOEAmericasBridge.id property.
     */
    Collection<? extends Integer> getHasPOEAmericasBridge.id();

    /**
     * Checks if the class has a hasPOEAmericasBridge.id property value.<p>
     * 
     * @return true if there is a hasPOEAmericasBridge.id property value.
     */
    boolean hasHasPOEAmericasBridge.id();

    /**
     * Adds a hasPOEAmericasBridge.id property value.<p>
     * 
     * @param newHasPOEAmericasBridge.id the hasPOEAmericasBridge.id property value to be added
     */
    void addHasPOEAmericasBridge.id(Integer newHasPOEAmericasBridge.id);

    /**
     * Removes a hasPOEAmericasBridge.id property value.<p>
     * 
     * @param oldHasPOEAmericasBridge.id the hasPOEAmericasBridge.id property value to be removed.
     */
    void removeHasPOEAmericasBridge.id(Integer oldHasPOEAmericasBridge.id);
