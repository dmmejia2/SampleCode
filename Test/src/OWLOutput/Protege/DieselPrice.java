 ...
 * Source Class: DieselPrice <br>
 * @version generated on Mon Mar 06 21:12:31 MST 2017 by danielmejia
 */

public interface DieselPrice extends WrappedIndividual {
    ...
    /* ***************************************************
     * Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasDieselPrice.Value
     */
     
    /**
     * Gets all property values for the hasDieselPrice.Value property.<p>
     * 
     * @returns a collection of values for the hasDieselPrice.Value property.
     */
    Collection<? extends Object> getHasDieselPrice.Value();

    /**
     * Checks if the class has a hasDieselPrice.Value property value.<p>
     * 
     * @return true if there is a hasDieselPrice.Value property value.
     */
    boolean hasHasDieselPrice.Value();

    /**
     * Adds a hasDieselPrice.Value property value.<p>
     * 
     * @param newHasDieselPrice.Value the hasDieselPrice.Value property value to be added
     */
    void addHasDieselPrice.Value(Object newHasDieselPrice.Value);

    /**
     * Removes a hasDieselPrice.Value property value.<p>
     * 
     * @param oldHasDieselPrice.Value the hasDieselPrice.Value property value to be removed.
     */
    void removeHasDieselPrice.Value(Object oldHasDieselPrice.Value);



    /* ***************************************************
     * Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasDieselPrice.id
     */
     
    /**
     * Gets all property values for the hasDieselPrice.id property.<p>
     * 
     * @returns a collection of values for the hasDieselPrice.id property.
     */
    Collection<? extends Integer> getHasDieselPrice.id();

    /**
     * Checks if the class has a hasDieselPrice.id property value.<p>
     * 
     * @return true if there is a hasDieselPrice.id property value.
     */
    boolean hasHasDieselPrice.id();

    /**
     * Adds a hasDieselPrice.id property value.<p>
     * 
     * @param newHasDieselPrice.id the hasDieselPrice.id property value to be added
     */
    void addHasDieselPrice.id(Integer newHasDieselPrice.id);

    /**
     * Removes a hasDieselPrice.id property value.<p>
     * 
     * @param oldHasDieselPrice.id the hasDieselPrice.id property value to be removed.
     */
    void removeHasDieselPrice.id(Integer oldHasDieselPrice.id);
