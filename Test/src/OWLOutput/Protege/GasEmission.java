 ...
 * Source Class: GasEmission <br>
 * @version generated on Mon Mar 06 21:12:31 MST 2017 by danielmejia
 */

public interface GasEmission extends COSO2NOXEmmission, CO2Emission {
    ...
    /* ***************************************************
     * Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasCO2Emission.Equivalent
     */
     
    /**
     * Gets all property values for the hasCO2Emission.Equivalent property.<p>
     * 
     * @returns a collection of values for the hasCO2Emission.Equivalent property.
     */
    Collection<? extends Object> getHasCO2Emission.Equivalent();

    /**
     * Checks if the class has a hasCO2Emission.Equivalent property value.<p>
     * 
     * @return true if there is a hasCO2Emission.Equivalent property value.
     */
    boolean hasHasCO2Emission.Equivalent();

    /**
     * Adds a hasCO2Emission.Equivalent property value.<p>
     * 
     * @param newHasCO2Emission.Equivalent the hasCO2Emission.Equivalent property value to be added
     */
    void addHasCO2Emission.Equivalent(Object newHasCO2Emission.Equivalent);

    /**
     * Removes a hasCO2Emission.Equivalent property value.<p>
     * 
     * @param oldHasCO2Emission.Equivalent the hasCO2Emission.Equivalent property value to be removed.
     */
    void removeHasCO2Emission.Equivalent(Object oldHasCO2Emission.Equivalent);



    /* ***************************************************
     * Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasCO2Emission.GasolineGallons
     */
     
    /**
     * Gets all property values for the hasCO2Emission.GasolineGallons property.<p>
     * 
     * @returns a collection of values for the hasCO2Emission.GasolineGallons property.
     */
    Collection<? extends Object> getHasCO2Emission.GasolineGallons();

    /**
     * Checks if the class has a hasCO2Emission.GasolineGallons property value.<p>
     * 
     * @return true if there is a hasCO2Emission.GasolineGallons property value.
     */
    boolean hasHasCO2Emission.GasolineGallons();

    /**
     * Adds a hasCO2Emission.GasolineGallons property value.<p>
     * 
     * @param newHasCO2Emission.GasolineGallons the hasCO2Emission.GasolineGallons property value to be added
     */
    void addHasCO2Emission.GasolineGallons(Object newHasCO2Emission.GasolineGallons);

    /**
     * Removes a hasCO2Emission.GasolineGallons property value.<p>
     * 
     * @param oldHasCO2Emission.GasolineGallons the hasCO2Emission.GasolineGallons property value to be removed.
     */
    void removeHasCO2Emission.GasolineGallons(Object oldHasCO2Emission.GasolineGallons);



    /* ***************************************************
     * Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasCO2Emission.id
     */
     
    /**
     * Gets all property values for the hasCO2Emission.id property.<p>
     * 
     * @returns a collection of values for the hasCO2Emission.id property.
     */
    Collection<? extends Integer> getHasCO2Emission.id();

    /**
     * Checks if the class has a hasCO2Emission.id property value.<p>
     * 
     * @return true if there is a hasCO2Emission.id property value.
     */
    boolean hasHasCO2Emission.id();

    /**
     * Adds a hasCO2Emission.id property value.<p>
     * 
     * @param newHasCO2Emission.id the hasCO2Emission.id property value to be added
     */
    void addHasCO2Emission.id(Integer newHasCO2Emission.id);

    /**
     * Removes a hasCO2Emission.id property value.<p>
     * 
     * @param oldHasCO2Emission.id the hasCO2Emission.id property value to be removed.
     */
    void removeHasCO2Emission.id(Integer oldHasCO2Emission.id);
