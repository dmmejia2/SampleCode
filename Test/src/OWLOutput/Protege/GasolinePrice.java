 ...
 * Source Class: GasolinePrice <br>
 * @version generated on Mon Mar 06 21:12:31 MST 2017 by danielmejia
 */

public interface GasolinePrice extends WrappedIndividual {
    ...
    /* ***************************************************
     * Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasGasolinePrice.Value
     */
     
    /**
     * Gets all property values for the hasGasolinePrice.Value property.<p>
     * 
     * @returns a collection of values for the hasGasolinePrice.Value property.
     */
    Collection<? extends Object> getHasGasolinePrice.Value();

    /**
     * Checks if the class has a hasGasolinePrice.Value property value.<p>
     * 
     * @return true if there is a hasGasolinePrice.Value property value.
     */
    boolean hasHasGasolinePrice.Value();

    /**
     * Adds a hasGasolinePrice.Value property value.<p>
     * 
     * @param newHasGasolinePrice.Value the hasGasolinePrice.Value property value to be added
     */
    void addHasGasolinePrice.Value(Object newHasGasolinePrice.Value);

    /**
     * Removes a hasGasolinePrice.Value property value.<p>
     * 
     * @param oldHasGasolinePrice.Value the hasGasolinePrice.Value property value to be removed.
     */
    void removeHasGasolinePrice.Value(Object oldHasGasolinePrice.Value);



    /* ***************************************************
     * Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasGasolinePrice.id
     */
     
    /**
     * Gets all property values for the hasGasolinePrice.id property.<p>
     * 
     * @returns a collection of values for the hasGasolinePrice.id property.
     */
    Collection<? extends Integer> getHasGasolinePrice.id();

    /**
     * Checks if the class has a hasGasolinePrice.id property value.<p>
     * 
     * @return true if there is a hasGasolinePrice.id property value.
     */
    boolean hasHasGasolinePrice.id();

    /**
     * Adds a hasGasolinePrice.id property value.<p>
     * 
     * @param newHasGasolinePrice.id the hasGasolinePrice.id property value to be added
     */
    void addHasGasolinePrice.id(Integer newHasGasolinePrice.id);

    /**
     * Removes a hasGasolinePrice.id property value.<p>
     * 
     * @param oldHasGasolinePrice.id the hasGasolinePrice.id property value to be removed.
     */
    void removeHasGasolinePrice.id(Integer oldHasGasolinePrice.id);
