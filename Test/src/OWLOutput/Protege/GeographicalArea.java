 ...
 * Source Class: GeographicalArea <br>
 * @version generated on Mon Mar 06 21:12:31 MST 2017 by danielmejia
 */

public interface GeographicalArea extends WrappedIndividual {
    ...
    /* ***************************************************
     * Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasGeographicalArea.City
     */
     
    /**
     * Gets all property values for the hasGeographicalArea.City property.<p>
     * 
     * @returns a collection of values for the hasGeographicalArea.City property.
     */
    Collection<? extends String> getHasGeographicalArea.City();

    /**
     * Checks if the class has a hasGeographicalArea.City property value.<p>
     * 
     * @return true if there is a hasGeographicalArea.City property value.
     */
    boolean hasHasGeographicalArea.City();

    /**
     * Adds a hasGeographicalArea.City property value.<p>
     * 
     * @param newHasGeographicalArea.City the hasGeographicalArea.City property value to be added
     */
    void addHasGeographicalArea.City(String newHasGeographicalArea.City);

    /**
     * Removes a hasGeographicalArea.City property value.<p>
     * 
     * @param oldHasGeographicalArea.City the hasGeographicalArea.City property value to be removed.
     */
    void removeHasGeographicalArea.City(String oldHasGeographicalArea.City);



    /* ***************************************************
     * Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasGeographicalArea.State
     */
     
    /**
     * Gets all property values for the hasGeographicalArea.State property.<p>
     * 
     * @returns a collection of values for the hasGeographicalArea.State property.
     */
    Collection<? extends String> getHasGeographicalArea.State();

    /**
     * Checks if the class has a hasGeographicalArea.State property value.<p>
     * 
     * @return true if there is a hasGeographicalArea.State property value.
     */
    boolean hasHasGeographicalArea.State();

    /**
     * Adds a hasGeographicalArea.State property value.<p>
     * 
     * @param newHasGeographicalArea.State the hasGeographicalArea.State property value to be added
     */
    void addHasGeographicalArea.State(String newHasGeographicalArea.State);

    /**
     * Removes a hasGeographicalArea.State property value.<p>
     * 
     * @param oldHasGeographicalArea.State the hasGeographicalArea.State property value to be removed.
     */
    void removeHasGeographicalArea.State(String oldHasGeographicalArea.State);



    /* ***************************************************
     * Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasGeographicalArea.id
     */
     
    /**
     * Gets all property values for the hasGeographicalArea.id property.<p>
     * 
     * @returns a collection of values for the hasGeographicalArea.id property.
     */
    Collection<? extends Integer> getHasGeographicalArea.id();

    /**
     * Checks if the class has a hasGeographicalArea.id property value.<p>
     * 
     * @return true if there is a hasGeographicalArea.id property value.
     */
    boolean hasHasGeographicalArea.id();

    /**
     * Adds a hasGeographicalArea.id property value.<p>
     * 
     * @param newHasGeographicalArea.id the hasGeographicalArea.id property value to be added
     */
    void addHasGeographicalArea.id(Integer newHasGeographicalArea.id);

    /**
     * Removes a hasGeographicalArea.id property value.<p>
     * 
     * @param oldHasGeographicalArea.id the hasGeographicalArea.id property value to be removed.
     */
    void removeHasGeographicalArea.id(Integer oldHasGeographicalArea.id);
