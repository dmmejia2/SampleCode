 ...
 * Source Class: PercentOfSystemCongestedClass <br>
 * @version generated on Mon Mar 06 21:12:31 MST 2017 by danielmejia
 */

public interface PercentOfSystemCongestedClass extends WrappedIndividual {
    ...
    /* ***************************************************
     * Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasPercentOfSystemCongested
     */
     
    /**
     * Gets all property values for the hasPercentOfSystemCongested property.<p>
     * 
     * @returns a collection of values for the hasPercentOfSystemCongested property.
     */
    Collection<? extends Object> getHasPercentOfSystemCongested();

    /**
     * Checks if the class has a hasPercentOfSystemCongested property value.<p>
     * 
     * @return true if there is a hasPercentOfSystemCongested property value.
     */
    boolean hasHasPercentOfSystemCongested();

    /**
     * Adds a hasPercentOfSystemCongested property value.<p>
     * 
     * @param newHasPercentOfSystemCongested the hasPercentOfSystemCongested property value to be added
     */
    void addHasPercentOfSystemCongested(Object newHasPercentOfSystemCongested);

    /**
     * Removes a hasPercentOfSystemCongested property value.<p>
     * 
     * @param oldHasPercentOfSystemCongested the hasPercentOfSystemCongested property value to be removed.
     */
    void removeHasPercentOfSystemCongested(Object oldHasPercentOfSystemCongested);



    /* ***************************************************
     * Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasPercentOfSystemCongested.id
     */
     
    /**
     * Gets all property values for the hasPercentOfSystemCongested.id property.<p>
     * 
     * @returns a collection of values for the hasPercentOfSystemCongested.id property.
     */
    Collection<? extends Integer> getHasPercentOfSystemCongested.id();

    /**
     * Checks if the class has a hasPercentOfSystemCongested.id property value.<p>
     * 
     * @return true if there is a hasPercentOfSystemCongested.id property value.
     */
    boolean hasHasPercentOfSystemCongested.id();

    /**
     * Adds a hasPercentOfSystemCongested.id property value.<p>
     * 
     * @param newHasPercentOfSystemCongested.id the hasPercentOfSystemCongested.id property value to be added
     */
    void addHasPercentOfSystemCongested.id(Integer newHasPercentOfSystemCongested.id);

    /**
     * Removes a hasPercentOfSystemCongested.id property value.<p>
     * 
     * @param oldHasPercentOfSystemCongested.id the hasPercentOfSystemCongested.id property value to be removed.
     */
    void removeHasPercentOfSystemCongested.id(Integer oldHasPercentOfSystemCongested.id);
