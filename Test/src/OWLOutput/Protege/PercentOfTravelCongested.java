 ...
 * Source Class: PercentOfTravelCongested <br>
 * @version generated on Mon Mar 06 21:12:31 MST 2017 by danielmejia
 */

public interface PercentOfTravelCongested extends WrappedIndividual {
    ...
    /* ***************************************************
     * Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasPercentOfTravelCongested
     */
     
    /**
     * Gets all property values for the hasPercentOfTravelCongested property.<p>
     * 
     * @returns a collection of values for the hasPercentOfTravelCongested property.
     */
    Collection<? extends Object> getHasPercentOfTravelCongested();

    /**
     * Checks if the class has a hasPercentOfTravelCongested property value.<p>
     * 
     * @return true if there is a hasPercentOfTravelCongested property value.
     */
    boolean hasHasPercentOfTravelCongested();

    /**
     * Adds a hasPercentOfTravelCongested property value.<p>
     * 
     * @param newHasPercentOfTravelCongested the hasPercentOfTravelCongested property value to be added
     */
    void addHasPercentOfTravelCongested(Object newHasPercentOfTravelCongested);

    /**
     * Removes a hasPercentOfTravelCongested property value.<p>
     * 
     * @param oldHasPercentOfTravelCongested the hasPercentOfTravelCongested property value to be removed.
     */
    void removeHasPercentOfTravelCongested(Object oldHasPercentOfTravelCongested);



    /* ***************************************************
     * Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasPercentOfTravelCongested.id
     */
     
    /**
     * Gets all property values for the hasPercentOfTravelCongested.id property.<p>
     * 
     * @returns a collection of values for the hasPercentOfTravelCongested.id property.
     */
    Collection<? extends Integer> getHasPercentOfTravelCongested.id();

    /**
     * Checks if the class has a hasPercentOfTravelCongested.id property value.<p>
     * 
     * @return true if there is a hasPercentOfTravelCongested.id property value.
     */
    boolean hasHasPercentOfTravelCongested.id();

    /**
     * Adds a hasPercentOfTravelCongested.id property value.<p>
     * 
     * @param newHasPercentOfTravelCongested.id the hasPercentOfTravelCongested.id property value to be added
     */
    void addHasPercentOfTravelCongested.id(Integer newHasPercentOfTravelCongested.id);

    /**
     * Removes a hasPercentOfTravelCongested.id property value.<p>
     * 
     * @param oldHasPercentOfTravelCongested.id the hasPercentOfTravelCongested.id property value to be removed.
     */
    void removeHasPercentOfTravelCongested.id(Integer oldHasPercentOfTravelCongested.id);
