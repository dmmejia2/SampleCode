 ...
 * Source Class: PortOfEntryAverageWaitingTime <br>
 * @version generated on Mon Mar 06 21:12:31 MST 2017 by danielmejia
 */

public interface PortOfEntryAverageWaitingTime extends YsletaBridgeAverageWaitingTime {
    ...
    /* ***************************************************
     * Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#isPartOf
     */
    ...
    /* ***************************************************
     * Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasPOE.Minutes
     */
     
    /**
     * Gets all property values for the hasPOE.Minutes property.<p>
     * 
     * @returns a collection of values for the hasPOE.Minutes property.
     */
    Collection<? extends String> getHasPOE.Minutes();

    /**
     * Checks if the class has a hasPOE.Minutes property value.<p>
     * 
     * @return true if there is a hasPOE.Minutes property value.
     */
    boolean hasHasPOE.Minutes();

    /**
     * Adds a hasPOE.Minutes property value.<p>
     * 
     * @param newHasPOE.Minutes the hasPOE.Minutes property value to be added
     */
    void addHasPOE.Minutes(String newHasPOE.Minutes);

    /**
     * Removes a hasPOE.Minutes property value.<p>
     * 
     * @param oldHasPOE.Minutes the hasPOE.Minutes property value to be removed.
     */
    void removeHasPOE.Minutes(String oldHasPOE.Minutes);



    /* ***************************************************
     * Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasPOE.id
     */
     
    /**
     * Gets all property values for the hasPOE.id property.<p>
     * 
     * @returns a collection of values for the hasPOE.id property.
     */
    Collection<? extends Integer> getHasPOE.id();

    /**
     * Checks if the class has a hasPOE.id property value.<p>
     * 
     * @return true if there is a hasPOE.id property value.
     */
    boolean hasHasPOE.id();

    /**
     * Adds a hasPOE.id property value.<p>
     * 
     * @param newHasPOE.id the hasPOE.id property value to be added
     */
    void addHasPOE.id(Integer newHasPOE.id);

    /**
     * Removes a hasPOE.id property value.<p>
     * 
     * @param oldHasPOE.id the hasPOE.id property value to be removed.
     */
    void removeHasPOE.id(Integer oldHasPOE.id);



    /* ***************************************************
     * Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasPOEYsletaBridge.id
     */
     
    /**
     * Gets all property values for the hasPOEYsletaBridge.id property.<p>
     * 
     * @returns a collection of values for the hasPOEYsletaBridge.id property.
     */
    Collection<? extends Integer> getHasPOEYsletaBridge.id();

    /**
     * Checks if the class has a hasPOEYsletaBridge.id property value.<p>
     * 
     * @return true if there is a hasPOEYsletaBridge.id property value.
     */
    boolean hasHasPOEYsletaBridge.id();

    /**
     * Adds a hasPOEYsletaBridge.id property value.<p>
     * 
     * @param newHasPOEYsletaBridge.id the hasPOEYsletaBridge.id property value to be added
     */
    void addHasPOEYsletaBridge.id(Integer newHasPOEYsletaBridge.id);

    /**
     * Removes a hasPOEYsletaBridge.id property value.<p>
     * 
     * @param oldHasPOEYsletaBridge.id the hasPOEYsletaBridge.id property value to be removed.
     */
    void removeHasPOEYsletaBridge.id(Integer oldHasPOEYsletaBridge.id);
