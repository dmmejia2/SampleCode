 ...
 * Source Class: ResponseTimeToIncidents <br>
 * @version generated on Mon Mar 06 21:12:31 MST 2017 by danielmejia
 */

public interface ResponseTimeToIncidents extends WrappedIndividual {

    /* ***************************************************
     * Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#TimeCausedBy
     */
     
    /**
     * Gets all property values for the TimeCausedBy property.<p>
     * 
     * @returns a collection of values for the TimeCausedBy property.
     */
    Collection<? extends Incident> getTimeCausedBy();

    /**
     * Checks if the class has a TimeCausedBy property value.<p>
     * 
     * @return true if there is a TimeCausedBy property value.
     */
    boolean hasTimeCausedBy();

    /**
     * Adds a TimeCausedBy property value.<p>
     * 
     * @param newTimeCausedBy the TimeCausedBy property value to be added
     */
    void addTimeCausedBy(Incident newTimeCausedBy);

    /**
     * Removes a TimeCausedBy property value.<p>
     * 
     * @param oldTimeCausedBy the TimeCausedBy property value to be removed.
     */
    void removeTimeCausedBy(Incident oldTimeCausedBy);
    ...
    /* ***************************************************
     * Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasResponseTimeToIncidents.ArrivalTime
     */
     
    /**
     * Gets all property values for the hasResponseTimeToIncidents.ArrivalTime property.<p>
     * 
     * @returns a collection of values for the hasResponseTimeToIncidents.ArrivalTime property.
     */
    Collection<? extends XMLGregorianCalendar> getHasResponseTimeToIncidents.ArrivalTime();

    /**
     * Checks if the class has a hasResponseTimeToIncidents.ArrivalTime property value.<p>
     * 
     * @return true if there is a hasResponseTimeToIncidents.ArrivalTime property value.
     */
    boolean hasHasResponseTimeToIncidents.ArrivalTime();

    /**
     * Adds a hasResponseTimeToIncidents.ArrivalTime property value.<p>
     * 
     * @param newHasResponseTimeToIncidents.ArrivalTime the hasResponseTimeToIncidents.ArrivalTime property value to be added
     */
    void addHasResponseTimeToIncidents.ArrivalTime(XMLGregorianCalendar newHasResponseTimeToIncidents.ArrivalTime);

    /**
     * Removes a hasResponseTimeToIncidents.ArrivalTime property value.<p>
     * 
     * @param oldHasResponseTimeToIncidents.ArrivalTime the hasResponseTimeToIncidents.ArrivalTime property value to be removed.
     */
    void removeHasResponseTimeToIncidents.ArrivalTime(XMLGregorianCalendar oldHasResponseTimeToIncidents.ArrivalTime);



    /* ***************************************************
     * Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasResponseTimeToIncidents.FinalResponseTime
     */
     
    /**
     * Gets all property values for the hasResponseTimeToIncidents.FinalResponseTime property.<p>
     * 
     * @returns a collection of values for the hasResponseTimeToIncidents.FinalResponseTime property.
     */
    Collection<? extends String> getHasResponseTimeToIncidents.FinalResponseTime();

    /**
     * Checks if the class has a hasResponseTimeToIncidents.FinalResponseTime property value.<p>
     * 
     * @return true if there is a hasResponseTimeToIncidents.FinalResponseTime property value.
     */
    boolean hasHasResponseTimeToIncidents.FinalResponseTime();

    /**
     * Adds a hasResponseTimeToIncidents.FinalResponseTime property value.<p>
     * 
     * @param newHasResponseTimeToIncidents.FinalResponseTime the hasResponseTimeToIncidents.FinalResponseTime property value to be added
     */
    void addHasResponseTimeToIncidents.FinalResponseTime(String newHasResponseTimeToIncidents.FinalResponseTime);

    /**
     * Removes a hasResponseTimeToIncidents.FinalResponseTime property value.<p>
     * 
     * @param oldHasResponseTimeToIncidents.FinalResponseTime the hasResponseTimeToIncidents.FinalResponseTime property value to be removed.
     */
    void removeHasResponseTimeToIncidents.FinalResponseTime(String oldHasResponseTimeToIncidents.FinalResponseTime);



    /* ***************************************************
     * Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasResponseTimeToIncidents.NotifyTime
     */
     
    /**
     * Gets all property values for the hasResponseTimeToIncidents.NotifyTime property.<p>
     * 
     * @returns a collection of values for the hasResponseTimeToIncidents.NotifyTime property.
     */
    Collection<? extends XMLGregorianCalendar> getHasResponseTimeToIncidents.NotifyTime();

    /**
     * Checks if the class has a hasResponseTimeToIncidents.NotifyTime property value.<p>
     * 
     * @return true if there is a hasResponseTimeToIncidents.NotifyTime property value.
     */
    boolean hasHasResponseTimeToIncidents.NotifyTime();

    /**
     * Adds a hasResponseTimeToIncidents.NotifyTime property value.<p>
     * 
     * @param newHasResponseTimeToIncidents.NotifyTime the hasResponseTimeToIncidents.NotifyTime property value to be added
     */
    void addHasResponseTimeToIncidents.NotifyTime(XMLGregorianCalendar newHasResponseTimeToIncidents.NotifyTime);

    /**
     * Removes a hasResponseTimeToIncidents.NotifyTime property value.<p>
     * 
     * @param oldHasResponseTimeToIncidents.NotifyTime the hasResponseTimeToIncidents.NotifyTime property value to be removed.
     */
    void removeHasResponseTimeToIncidents.NotifyTime(XMLGregorianCalendar oldHasResponseTimeToIncidents.NotifyTime);



    /* ***************************************************
     * Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasResponseTimeToIncidents.Unit
     */
     
    /**
     * Gets all property values for the hasResponseTimeToIncidents.Unit property.<p>
     * 
     * @returns a collection of values for the hasResponseTimeToIncidents.Unit property.
     */
    Collection<? extends String> getHasResponseTimeToIncidents.Unit();

    /**
     * Checks if the class has a hasResponseTimeToIncidents.Unit property value.<p>
     * 
     * @return true if there is a hasResponseTimeToIncidents.Unit property value.
     */
    boolean hasHasResponseTimeToIncidents.Unit();

    /**
     * Adds a hasResponseTimeToIncidents.Unit property value.<p>
     * 
     * @param newHasResponseTimeToIncidents.Unit the hasResponseTimeToIncidents.Unit property value to be added
     */
    void addHasResponseTimeToIncidents.Unit(String newHasResponseTimeToIncidents.Unit);

    /**
     * Removes a hasResponseTimeToIncidents.Unit property value.<p>
     * 
     * @param oldHasResponseTimeToIncidents.Unit the hasResponseTimeToIncidents.Unit property value to be removed.
     */
    void removeHasResponseTimeToIncidents.Unit(String oldHasResponseTimeToIncidents.Unit);



    /* ***************************************************
     * Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasResponseTimeToIncidents.id
     */
     
    /**
     * Gets all property values for the hasResponseTimeToIncidents.id property.<p>
     * 
     * @returns a collection of values for the hasResponseTimeToIncidents.id property.
     */
    Collection<? extends Integer> getHasResponseTimeToIncidents.id();

    /**
     * Checks if the class has a hasResponseTimeToIncidents.id property value.<p>
     * 
     * @return true if there is a hasResponseTimeToIncidents.id property value.
     */
    boolean hasHasResponseTimeToIncidents.id();

    /**
     * Adds a hasResponseTimeToIncidents.id property value.<p>
     * 
     * @param newHasResponseTimeToIncidents.id the hasResponseTimeToIncidents.id property value to be added
     */
    void addHasResponseTimeToIncidents.id(Integer newHasResponseTimeToIncidents.id);

    /**
     * Removes a hasResponseTimeToIncidents.id property value.<p>
     * 
     * @param oldHasResponseTimeToIncidents.id the hasResponseTimeToIncidents.id property value to be removed.
     */
    void removeHasResponseTimeToIncidents.id(Integer oldHasResponseTimeToIncidents.id);
