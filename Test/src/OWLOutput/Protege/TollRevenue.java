 ...
 * Source Class: TollRevenue <br>
 * @version generated on Mon Mar 06 21:12:31 MST 2017 by danielmejia
 */

public interface TollRevenue extends WrappedIndividual {
    ...
    /* ***************************************************
     * Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasTollRevenue.Value
     */
     
    /**
     * Gets all property values for the hasTollRevenue.Value property.<p>
     * 
     * @returns a collection of values for the hasTollRevenue.Value property.
     */
    Collection<? extends Object> getHasTollRevenue.Value();

    /**
     * Checks if the class has a hasTollRevenue.Value property value.<p>
     * 
     * @return true if there is a hasTollRevenue.Value property value.
     */
    boolean hasHasTollRevenue.Value();

    /**
     * Adds a hasTollRevenue.Value property value.<p>
     * 
     * @param newHasTollRevenue.Value the hasTollRevenue.Value property value to be added
     */
    void addHasTollRevenue.Value(Object newHasTollRevenue.Value);

    /**
     * Removes a hasTollRevenue.Value property value.<p>
     * 
     * @param oldHasTollRevenue.Value the hasTollRevenue.Value property value to be removed.
     */
    void removeHasTollRevenue.Value(Object oldHasTollRevenue.Value);



    /* ***************************************************
     * Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasTollRevenue.id
     */
     
    /**
     * Gets all property values for the hasTollRevenue.id property.<p>
     * 
     * @returns a collection of values for the hasTollRevenue.id property.
     */
    Collection<? extends Integer> getHasTollRevenue.id();

    /**
     * Checks if the class has a hasTollRevenue.id property value.<p>
     * 
     * @return true if there is a hasTollRevenue.id property value.
     */
    boolean hasHasTollRevenue.id();

    /**
     * Adds a hasTollRevenue.id property value.<p>
     * 
     * @param newHasTollRevenue.id the hasTollRevenue.id property value to be added
     */
    void addHasTollRevenue.id(Integer newHasTollRevenue.id);

    /**
     * Removes a hasTollRevenue.id property value.<p>
     * 
     * @param oldHasTollRevenue.id the hasTollRevenue.id property value to be removed.
     */
    void removeHasTollRevenue.id(Integer oldHasTollRevenue.id);
