 ...
 * Source Class: TrafficVolume <br>
 * @version generated on Mon Mar 06 21:12:32 MST 2017 by danielmejia
 */

public interface TrafficVolume extends WrappedIndividual {

    /* ***************************************************
     * Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#Calculates
     */
     
    /**
     * Gets all property values for the Calculates property.<p>
     * 
     * @returns a collection of values for the Calculates property.
     */
    Collection<? extends WrappedIndividual> getCalculates();

    /**
     * Checks if the class has a Calculates property value.<p>
     * 
     * @return true if there is a Calculates property value.
     */
    boolean hasCalculates();

    /**
     * Adds a Calculates property value.<p>
     * 
     * @param newCalculates the Calculates property value to be added
     */
    void addCalculates(WrappedIndividual newCalculates);

    /**
     * Removes a Calculates property value.<p>
     * 
     * @param oldCalculates the Calculates property value to be removed.
     */
    void removeCalculates(WrappedIndividual oldCalculates);


    /* ***************************************************
     * Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#affects
     */
     
    /**
     * Gets all property values for the affects property.<p>
     * 
     * @returns a collection of values for the affects property.
     */
    Collection<? extends WrappedIndividual> getAffects();

    /**
     * Checks if the class has a affects property value.<p>
     * 
     * @return true if there is a affects property value.
     */
    boolean hasAffects();

    /**
     * Adds a affects property value.<p>
     * 
     * @param newAffects the affects property value to be added
     */
    void addAffects(WrappedIndividual newAffects);

    /**
     * Removes a affects property value.<p>
     * 
     * @param oldAffects the affects property value to be removed.
     */
    void removeAffects(WrappedIndividual oldAffects);
    ...
    /* ***************************************************
     * Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#multiplyByLength
     */
     
    /**
     * Gets all property values for the multiplyByLength property.<p>
     * 
     * @returns a collection of values for the multiplyByLength property.
     */
    Collection<? extends VehicleMilesTraveled> getMultiplyByLength();

    /**
     * Checks if the class has a multiplyByLength property value.<p>
     * 
     * @return true if there is a multiplyByLength property value.
     */
    boolean hasMultiplyByLength();

    /**
     * Adds a multiplyByLength property value.<p>
     * 
     * @param newMultiplyByLength the multiplyByLength property value to be added
     */
    void addMultiplyByLength(VehicleMilesTraveled newMultiplyByLength);

    /**
     * Removes a multiplyByLength property value.<p>
     * 
     * @param oldMultiplyByLength the multiplyByLength property value to be removed.
     */
    void removeMultiplyByLength(VehicleMilesTraveled oldMultiplyByLength);
    ...
    /* ***************************************************
     * Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasTrafficVolume.IntersectionStreet
     */
     
    /**
     * Gets all property values for the hasTrafficVolume.IntersectionStreet property.<p>
     * 
     * @returns a collection of values for the hasTrafficVolume.IntersectionStreet property.
     */
    Collection<? extends String> getHasTrafficVolume.IntersectionStreet();

    /**
     * Checks if the class has a hasTrafficVolume.IntersectionStreet property value.<p>
     * 
     * @return true if there is a hasTrafficVolume.IntersectionStreet property value.
     */
    boolean hasHasTrafficVolume.IntersectionStreet();

    /**
     * Adds a hasTrafficVolume.IntersectionStreet property value.<p>
     * 
     * @param newHasTrafficVolume.IntersectionStreet the hasTrafficVolume.IntersectionStreet property value to be added
     */
    void addHasTrafficVolume.IntersectionStreet(String newHasTrafficVolume.IntersectionStreet);

    /**
     * Removes a hasTrafficVolume.IntersectionStreet property value.<p>
     * 
     * @param oldHasTrafficVolume.IntersectionStreet the hasTrafficVolume.IntersectionStreet property value to be removed.
     */
    void removeHasTrafficVolume.IntersectionStreet(String oldHasTrafficVolume.IntersectionStreet);



    /* ***************************************************
     * Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasTrafficVolume.PrimaryStreet
     */
     
    /**
     * Gets all property values for the hasTrafficVolume.PrimaryStreet property.<p>
     * 
     * @returns a collection of values for the hasTrafficVolume.PrimaryStreet property.
     */
    Collection<? extends String> getHasTrafficVolume.PrimaryStreet();

    /**
     * Checks if the class has a hasTrafficVolume.PrimaryStreet property value.<p>
     * 
     * @return true if there is a hasTrafficVolume.PrimaryStreet property value.
     */
    boolean hasHasTrafficVolume.PrimaryStreet();

    /**
     * Adds a hasTrafficVolume.PrimaryStreet property value.<p>
     * 
     * @param newHasTrafficVolume.PrimaryStreet the hasTrafficVolume.PrimaryStreet property value to be added
     */
    void addHasTrafficVolume.PrimaryStreet(String newHasTrafficVolume.PrimaryStreet);

    /**
     * Removes a hasTrafficVolume.PrimaryStreet property value.<p>
     * 
     * @param oldHasTrafficVolume.PrimaryStreet the hasTrafficVolume.PrimaryStreet property value to be removed.
     */
    void removeHasTrafficVolume.PrimaryStreet(String oldHasTrafficVolume.PrimaryStreet);



    /* ***************************************************
     * Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasTrafficVolume.Volume
     */
     
    /**
     * Gets all property values for the hasTrafficVolume.Volume property.<p>
     * 
     * @returns a collection of values for the hasTrafficVolume.Volume property.
     */
    Collection<? extends Integer> getHasTrafficVolume.Volume();

    /**
     * Checks if the class has a hasTrafficVolume.Volume property value.<p>
     * 
     * @return true if there is a hasTrafficVolume.Volume property value.
     */
    boolean hasHasTrafficVolume.Volume();

    /**
     * Adds a hasTrafficVolume.Volume property value.<p>
     * 
     * @param newHasTrafficVolume.Volume the hasTrafficVolume.Volume property value to be added
     */
    void addHasTrafficVolume.Volume(Integer newHasTrafficVolume.Volume);

    /**
     * Removes a hasTrafficVolume.Volume property value.<p>
     * 
     * @param oldHasTrafficVolume.Volume the hasTrafficVolume.Volume property value to be removed.
     */
    void removeHasTrafficVolume.Volume(Integer oldHasTrafficVolume.Volume);



    /* ***************************************************
     * Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasTrafficVolume.id
     */
     
    /**
     * Gets all property values for the hasTrafficVolume.id property.<p>
     * 
     * @returns a collection of values for the hasTrafficVolume.id property.
     */
    Collection<? extends Integer> getHasTrafficVolume.id();

    /**
     * Checks if the class has a hasTrafficVolume.id property value.<p>
     * 
     * @return true if there is a hasTrafficVolume.id property value.
     */
    boolean hasHasTrafficVolume.id();

    /**
     * Adds a hasTrafficVolume.id property value.<p>
     * 
     * @param newHasTrafficVolume.id the hasTrafficVolume.id property value to be added
     */
    void addHasTrafficVolume.id(Integer newHasTrafficVolume.id);

    /**
     * Removes a hasTrafficVolume.id property value.<p>
     * 
     * @param oldHasTrafficVolume.id the hasTrafficVolume.id property value to be removed.
     */
    void removeHasTrafficVolume.id(Integer oldHasTrafficVolume.id);
