 ...
 * Source Class: TravelTimeIndex <br>
 * @version generated on Mon Mar 06 21:12:32 MST 2017 by danielmejia
 */

public interface TravelTimeIndex extends WrappedIndividual {
    ...
    /* ***************************************************
     * Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasTravelTimeIndex.Value
     */
     
    /**
     * Gets all property values for the hasTravelTimeIndex.Value property.<p>
     * 
     * @returns a collection of values for the hasTravelTimeIndex.Value property.
     */
    Collection<? extends Object> getHasTravelTimeIndex.Value();

    /**
     * Checks if the class has a hasTravelTimeIndex.Value property value.<p>
     * 
     * @return true if there is a hasTravelTimeIndex.Value property value.
     */
    boolean hasHasTravelTimeIndex.Value();

    /**
     * Adds a hasTravelTimeIndex.Value property value.<p>
     * 
     * @param newHasTravelTimeIndex.Value the hasTravelTimeIndex.Value property value to be added
     */
    void addHasTravelTimeIndex.Value(Object newHasTravelTimeIndex.Value);

    /**
     * Removes a hasTravelTimeIndex.Value property value.<p>
     * 
     * @param oldHasTravelTimeIndex.Value the hasTravelTimeIndex.Value property value to be removed.
     */
    void removeHasTravelTimeIndex.Value(Object oldHasTravelTimeIndex.Value);



    /* ***************************************************
     * Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasTravelTimeIndex.id
     */
     
    /**
     * Gets all property values for the hasTravelTimeIndex.id property.<p>
     * 
     * @returns a collection of values for the hasTravelTimeIndex.id property.
     */
    Collection<? extends Integer> getHasTravelTimeIndex.id();

    /**
     * Checks if the class has a hasTravelTimeIndex.id property value.<p>
     * 
     * @return true if there is a hasTravelTimeIndex.id property value.
     */
    boolean hasHasTravelTimeIndex.id();

    /**
     * Adds a hasTravelTimeIndex.id property value.<p>
     * 
     * @param newHasTravelTimeIndex.id the hasTravelTimeIndex.id property value to be added
     */
    void addHasTravelTimeIndex.id(Integer newHasTravelTimeIndex.id);

    /**
     * Removes a hasTravelTimeIndex.id property value.<p>
     * 
     * @param oldHasTravelTimeIndex.id the hasTravelTimeIndex.id property value to be removed.
     */
    void removeHasTravelTimeIndex.id(Integer oldHasTravelTimeIndex.id);
