 ...
 * Source Class: ValueOfTime <br>
 * @version generated on Mon Mar 06 21:12:32 MST 2017 by danielmejia
 */

public interface ValueOfTime extends WrappedIndividual {

    /* ***************************************************
     * Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#costOf
     */
     
    /**
     * Gets all property values for the costOf property.<p>
     * 
     * @returns a collection of values for the costOf property.
     */
    Collection<? extends TravelTime> getCostOf();

    /**
     * Checks if the class has a costOf property value.<p>
     * 
     * @return true if there is a costOf property value.
     */
    boolean hasCostOf();

    /**
     * Adds a costOf property value.<p>
     * 
     * @param newCostOf the costOf property value to be added
     */
    void addCostOf(TravelTime newCostOf);

    /**
     * Removes a costOf property value.<p>
     * 
     * @param oldCostOf the costOf property value to be removed.
     */
    void removeCostOf(TravelTime oldCostOf);
    ...
    /* ***************************************************
     * Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasValueOfTime.Value
     */
     
    /**
     * Gets all property values for the hasValueOfTime.Value property.<p>
     * 
     * @returns a collection of values for the hasValueOfTime.Value property.
     */
    Collection<? extends Object> getHasValueOfTime.Value();

    /**
     * Checks if the class has a hasValueOfTime.Value property value.<p>
     * 
     * @return true if there is a hasValueOfTime.Value property value.
     */
    boolean hasHasValueOfTime.Value();

    /**
     * Adds a hasValueOfTime.Value property value.<p>
     * 
     * @param newHasValueOfTime.Value the hasValueOfTime.Value property value to be added
     */
    void addHasValueOfTime.Value(Object newHasValueOfTime.Value);

    /**
     * Removes a hasValueOfTime.Value property value.<p>
     * 
     * @param oldHasValueOfTime.Value the hasValueOfTime.Value property value to be removed.
     */
    void removeHasValueOfTime.Value(Object oldHasValueOfTime.Value);



    /* ***************************************************
     * Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasValueOfTime.id
     */
     
    /**
     * Gets all property values for the hasValueOfTime.id property.<p>
     * 
     * @returns a collection of values for the hasValueOfTime.id property.
     */
    Collection<? extends Integer> getHasValueOfTime.id();

    /**
     * Checks if the class has a hasValueOfTime.id property value.<p>
     * 
     * @return true if there is a hasValueOfTime.id property value.
     */
    boolean hasHasValueOfTime.id();

    /**
     * Adds a hasValueOfTime.id property value.<p>
     * 
     * @param newHasValueOfTime.id the hasValueOfTime.id property value to be added
     */
    void addHasValueOfTime.id(Integer newHasValueOfTime.id);

    /**
     * Removes a hasValueOfTime.id property value.<p>
     * 
     * @param oldHasValueOfTime.id the hasValueOfTime.id property value to be removed.
     */
    void removeHasValueOfTime.id(Integer oldHasValueOfTime.id);
