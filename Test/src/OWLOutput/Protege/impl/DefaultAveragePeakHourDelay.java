 ...
 * Source Class: DefaultAveragePeakHourDelay <br>
 * @version generated on Mon Mar 06 21:12:30 MST 2017 by danielmejia
 */
public class DefaultAveragePeakHourDelay extends WrappedIndividualImpl implements AveragePeakHourDelay {

    public DefaultAveragePeakHourDelay(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
    }
    ...
    /* ***************************************************
     * Data Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasAveragePeakHourDelay.AveragePeakYear
     */
     
    public Collection<? extends Integer> getHasAveragePeakHourDelay.AveragePeakYear() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASAVERAGEPEAKHOURDELAY.AVERAGEPEAKYEAR, Integer.class);
    }

    public boolean hasHasAveragePeakHourDelay.AveragePeakYear() {
		return !getHasAveragePeakHourDelay.AveragePeakYear().isEmpty();
    }

    public void addHasAveragePeakHourDelay.AveragePeakYear(Integer newHasAveragePeakHourDelay.AveragePeakYear) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASAVERAGEPEAKHOURDELAY.AVERAGEPEAKYEAR, newHasAveragePeakHourDelay.AveragePeakYear);
    }

    public void removeHasAveragePeakHourDelay.AveragePeakYear(Integer oldHasAveragePeakHourDelay.AveragePeakYear) {
		getDelegate().removePropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASAVERAGEPEAKHOURDELAY.AVERAGEPEAKYEAR, oldHasAveragePeakHourDelay.AveragePeakYear);
    }


    /* ***************************************************
     * Data Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasAveragePeakHourDelay.id
     */
     
    public Collection<? extends Integer> getHasAveragePeakHourDelay.id() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASAVERAGEPEAKHOURDELAY.ID, Integer.class);
    }

    public boolean hasHasAveragePeakHourDelay.id() {
		return !getHasAveragePeakHourDelay.id().isEmpty();
    }

    public void addHasAveragePeakHourDelay.id(Integer newHasAveragePeakHourDelay.id) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASAVERAGEPEAKHOURDELAY.ID, newHasAveragePeakHourDelay.id);
    }

    public void removeHasAveragePeakHourDelay.id(Integer oldHasAveragePeakHourDelay.id) {
		getDelegate().removePropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASAVERAGEPEAKHOURDELAY.ID, oldHasAveragePeakHourDelay.id);
    }
