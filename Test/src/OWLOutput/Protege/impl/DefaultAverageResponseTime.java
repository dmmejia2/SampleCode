 ...
 * Source Class: DefaultAverageResponseTime <br>
 * @version generated on Mon Mar 06 21:12:30 MST 2017 by danielmejia
 */
public class DefaultAverageResponseTime extends WrappedIndividualImpl implements AverageResponseTime {

    public DefaultAverageResponseTime(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
    }
    ...
    /* ***************************************************
     * Data Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasAverageResponseTime.AverageValue
     */
     
    public Collection<? extends Object> getHasAverageResponseTime.AverageValue() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASAVERAGERESPONSETIME.AVERAGEVALUE, Object.class);
    }

    public boolean hasHasAverageResponseTime.AverageValue() {
		return !getHasAverageResponseTime.AverageValue().isEmpty();
    }

    public void addHasAverageResponseTime.AverageValue(Object newHasAverageResponseTime.AverageValue) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASAVERAGERESPONSETIME.AVERAGEVALUE, newHasAverageResponseTime.AverageValue);
    }

    public void removeHasAverageResponseTime.AverageValue(Object oldHasAverageResponseTime.AverageValue) {
		getDelegate().removePropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASAVERAGERESPONSETIME.AVERAGEVALUE, oldHasAverageResponseTime.AverageValue);
    }


    /* ***************************************************
     * Data Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasAverageResponseTime.Unit
     */
     
    public Collection<? extends XMLGregorianCalendar> getHasAverageResponseTime.Unit() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASAVERAGERESPONSETIME.UNIT, XMLGregorianCalendar.class);
    }

    public boolean hasHasAverageResponseTime.Unit() {
		return !getHasAverageResponseTime.Unit().isEmpty();
    }

    public void addHasAverageResponseTime.Unit(XMLGregorianCalendar newHasAverageResponseTime.Unit) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASAVERAGERESPONSETIME.UNIT, newHasAverageResponseTime.Unit);
    }

    public void removeHasAverageResponseTime.Unit(XMLGregorianCalendar oldHasAverageResponseTime.Unit) {
		getDelegate().removePropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASAVERAGERESPONSETIME.UNIT, oldHasAverageResponseTime.Unit);
    }


    /* ***************************************************
     * Data Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasAverageResponseTime.Year
     */
     
    public Collection<? extends Integer> getHasAverageResponseTime.Year() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASAVERAGERESPONSETIME.YEAR, Integer.class);
    }

    public boolean hasHasAverageResponseTime.Year() {
		return !getHasAverageResponseTime.Year().isEmpty();
    }

    public void addHasAverageResponseTime.Year(Integer newHasAverageResponseTime.Year) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASAVERAGERESPONSETIME.YEAR, newHasAverageResponseTime.Year);
    }

    public void removeHasAverageResponseTime.Year(Integer oldHasAverageResponseTime.Year) {
		getDelegate().removePropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASAVERAGERESPONSETIME.YEAR, oldHasAverageResponseTime.Year);
    }


    /* ***************************************************
     * Data Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasAverageResponseTime.id
     */
     
    public Collection<? extends Integer> getHasAverageResponseTime.id() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASAVERAGERESPONSETIME.ID, Integer.class);
    }

    public boolean hasHasAverageResponseTime.id() {
		return !getHasAverageResponseTime.id().isEmpty();
    }

    public void addHasAverageResponseTime.id(Integer newHasAverageResponseTime.id) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASAVERAGERESPONSETIME.ID, newHasAverageResponseTime.id);
    }

    public void removeHasAverageResponseTime.id(Integer oldHasAverageResponseTime.id) {
		getDelegate().removePropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASAVERAGERESPONSETIME.ID, oldHasAverageResponseTime.id);
    }
