 ...
 * Source Class: DefaultCongestionCost <br>
 * @version generated on Mon Mar 06 21:12:30 MST 2017 by danielmejia
 */
public class DefaultCongestionCost extends WrappedIndividualImpl implements CongestionCost {

    public DefaultCongestionCost(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
    }
    ...
    /* ***************************************************
     * Data Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasCongestionCost
     */
     
    public Collection<? extends Integer> getHasCongestionCost() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASCONGESTIONCOST, Integer.class);
    }

    public boolean hasHasCongestionCost() {
		return !getHasCongestionCost().isEmpty();
    }

    public void addHasCongestionCost(Integer newHasCongestionCost) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASCONGESTIONCOST, newHasCongestionCost);
    }

    public void removeHasCongestionCost(Integer oldHasCongestionCost) {
		getDelegate().removePropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASCONGESTIONCOST, oldHasCongestionCost);
    }
    ...
    /* ***************************************************
     * Data Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasCongestionTime.RushHours
     */
     
    public Collection<? extends Object> getHasCongestionTime.RushHours() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASCONGESTIONTIME.RUSHHOURS, Object.class);
    }

    public boolean hasHasCongestionTime.RushHours() {
		return !getHasCongestionTime.RushHours().isEmpty();
    }

    public void addHasCongestionTime.RushHours(Object newHasCongestionTime.RushHours) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASCONGESTIONTIME.RUSHHOURS, newHasCongestionTime.RushHours);
    }

    public void removeHasCongestionTime.RushHours(Object oldHasCongestionTime.RushHours) {
		getDelegate().removePropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASCONGESTIONTIME.RUSHHOURS, oldHasCongestionTime.RushHours);
    }
