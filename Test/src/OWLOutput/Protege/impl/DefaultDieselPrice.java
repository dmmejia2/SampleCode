 ...
 * Source Class: DefaultDieselPrice <br>
 * @version generated on Mon Mar 06 21:12:31 MST 2017 by danielmejia
 */
public class DefaultDieselPrice extends WrappedIndividualImpl implements DieselPrice {

    public DefaultDieselPrice(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
    }
    ...
    /* ***************************************************
     * Data Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasDieselPrice.Value
     */
     
    public Collection<? extends Object> getHasDieselPrice.Value() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASDIESELPRICE.VALUE, Object.class);
    }

    public boolean hasHasDieselPrice.Value() {
		return !getHasDieselPrice.Value().isEmpty();
    }

    public void addHasDieselPrice.Value(Object newHasDieselPrice.Value) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASDIESELPRICE.VALUE, newHasDieselPrice.Value);
    }

    public void removeHasDieselPrice.Value(Object oldHasDieselPrice.Value) {
		getDelegate().removePropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASDIESELPRICE.VALUE, oldHasDieselPrice.Value);
    }


    /* ***************************************************
     * Data Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasDieselPrice.id
     */
     
    public Collection<? extends Integer> getHasDieselPrice.id() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASDIESELPRICE.ID, Integer.class);
    }

    public boolean hasHasDieselPrice.id() {
		return !getHasDieselPrice.id().isEmpty();
    }

    public void addHasDieselPrice.id(Integer newHasDieselPrice.id) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASDIESELPRICE.ID, newHasDieselPrice.id);
    }

    public void removeHasDieselPrice.id(Integer oldHasDieselPrice.id) {
		getDelegate().removePropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASDIESELPRICE.ID, oldHasDieselPrice.id);
    }
