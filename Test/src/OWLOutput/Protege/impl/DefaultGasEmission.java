 ...
 * Source Class: DefaultGasEmission <br>
 * @version generated on Mon Mar 06 21:12:31 MST 2017 by danielmejia
 */
public class DefaultGasEmission extends WrappedIndividualImpl implements GasEmission {

    public DefaultGasEmission(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
    }
    ...
    /* ***************************************************
     * Data Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasCO2Emission.Equivalent
     */
     
    public Collection<? extends Object> getHasCO2Emission.Equivalent() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASCO2EMISSION.EQUIVALENT, Object.class);
    }

    public boolean hasHasCO2Emission.Equivalent() {
		return !getHasCO2Emission.Equivalent().isEmpty();
    }

    public void addHasCO2Emission.Equivalent(Object newHasCO2Emission.Equivalent) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASCO2EMISSION.EQUIVALENT, newHasCO2Emission.Equivalent);
    }

    public void removeHasCO2Emission.Equivalent(Object oldHasCO2Emission.Equivalent) {
		getDelegate().removePropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASCO2EMISSION.EQUIVALENT, oldHasCO2Emission.Equivalent);
    }


    /* ***************************************************
     * Data Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasCO2Emission.GasolineGallons
     */
     
    public Collection<? extends Object> getHasCO2Emission.GasolineGallons() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASCO2EMISSION.GASOLINEGALLONS, Object.class);
    }

    public boolean hasHasCO2Emission.GasolineGallons() {
		return !getHasCO2Emission.GasolineGallons().isEmpty();
    }

    public void addHasCO2Emission.GasolineGallons(Object newHasCO2Emission.GasolineGallons) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASCO2EMISSION.GASOLINEGALLONS, newHasCO2Emission.GasolineGallons);
    }

    public void removeHasCO2Emission.GasolineGallons(Object oldHasCO2Emission.GasolineGallons) {
		getDelegate().removePropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASCO2EMISSION.GASOLINEGALLONS, oldHasCO2Emission.GasolineGallons);
    }


    /* ***************************************************
     * Data Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasCO2Emission.id
     */
     
    public Collection<? extends Integer> getHasCO2Emission.id() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASCO2EMISSION.ID, Integer.class);
    }

    public boolean hasHasCO2Emission.id() {
		return !getHasCO2Emission.id().isEmpty();
    }

    public void addHasCO2Emission.id(Integer newHasCO2Emission.id) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASCO2EMISSION.ID, newHasCO2Emission.id);
    }

    public void removeHasCO2Emission.id(Integer oldHasCO2Emission.id) {
		getDelegate().removePropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASCO2EMISSION.ID, oldHasCO2Emission.id);
    }
