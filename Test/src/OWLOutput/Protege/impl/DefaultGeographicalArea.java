 ...
 * Source Class: DefaultGeographicalArea <br>
 * @version generated on Mon Mar 06 21:12:31 MST 2017 by danielmejia
 */
public class DefaultGeographicalArea extends WrappedIndividualImpl implements GeographicalArea {

    public DefaultGeographicalArea(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
    }
    ...
    /* ***************************************************
     * Data Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasGeographicalArea.City
     */
     
    public Collection<? extends String> getHasGeographicalArea.City() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASGEOGRAPHICALAREA.CITY, String.class);
    }

    public boolean hasHasGeographicalArea.City() {
		return !getHasGeographicalArea.City().isEmpty();
    }

    public void addHasGeographicalArea.City(String newHasGeographicalArea.City) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASGEOGRAPHICALAREA.CITY, newHasGeographicalArea.City);
    }

    public void removeHasGeographicalArea.City(String oldHasGeographicalArea.City) {
		getDelegate().removePropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASGEOGRAPHICALAREA.CITY, oldHasGeographicalArea.City);
    }


    /* ***************************************************
     * Data Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasGeographicalArea.State
     */
     
    public Collection<? extends String> getHasGeographicalArea.State() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASGEOGRAPHICALAREA.STATE, String.class);
    }

    public boolean hasHasGeographicalArea.State() {
		return !getHasGeographicalArea.State().isEmpty();
    }

    public void addHasGeographicalArea.State(String newHasGeographicalArea.State) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASGEOGRAPHICALAREA.STATE, newHasGeographicalArea.State);
    }

    public void removeHasGeographicalArea.State(String oldHasGeographicalArea.State) {
		getDelegate().removePropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASGEOGRAPHICALAREA.STATE, oldHasGeographicalArea.State);
    }


    /* ***************************************************
     * Data Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasGeographicalArea.id
     */
     
    public Collection<? extends Integer> getHasGeographicalArea.id() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASGEOGRAPHICALAREA.ID, Integer.class);
    }

    public boolean hasHasGeographicalArea.id() {
		return !getHasGeographicalArea.id().isEmpty();
    }

    public void addHasGeographicalArea.id(Integer newHasGeographicalArea.id) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASGEOGRAPHICALAREA.ID, newHasGeographicalArea.id);
    }

    public void removeHasGeographicalArea.id(Integer oldHasGeographicalArea.id) {
		getDelegate().removePropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASGEOGRAPHICALAREA.ID, oldHasGeographicalArea.id);
    }
