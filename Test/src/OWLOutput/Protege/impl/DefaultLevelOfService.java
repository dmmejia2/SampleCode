 ...
 * Source Class: DefaultLevelOfService <br>
 * @version generated on Mon Mar 06 21:12:31 MST 2017 by danielmejia
 */
public class DefaultLevelOfService extends WrappedIndividualImpl implements LevelOfService {

    public DefaultLevelOfService(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
    }
    ...
    /* ***************************************************
     * Object Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#uses
     */
     
    public Collection<? extends Speed> getUses() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
    ...
    public void addUses(Speed newUses) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_USES,
                                       newUses);
    }

    public void removeUses(Speed oldUses) {
        getDelegate().removePropertyValue(getOwlIndividual(),
                                          Vocabulary.OBJECT_PROPERTY_USES,
                                          oldUses);
    }
