...
public class DefaultOccupant extends WrappedIndividualImpl implements Occupant {
    ...
    public Collection<? extends Integer> getHasRestraintType() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASRESTRAINTTYPE, Integer.class);
    }

    public boolean hasHasRestraintType() {
		return !getHasRestraintType().isEmpty();
    }

    public void addHasRestraintType(Integer newHasRestraintType) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASRESTRAINTTYPE, newHasRestraintType);
    }

    public void removeHasRestraintType(Integer oldHasRestraintType) {
		getDelegate().removePropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASRESTRAINTTYPE, oldHasRestraintType);
    }
