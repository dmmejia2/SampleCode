 ...
 * Source Class: DefaultPercentOfSystemCongestedClass <br>
 * @version generated on Mon Mar 06 21:12:31 MST 2017 by danielmejia
 */
public class DefaultPercentOfSystemCongestedClass extends WrappedIndividualImpl implements PercentOfSystemCongestedClass {

    public DefaultPercentOfSystemCongestedClass(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
    }
    ...
    /* ***************************************************
     * Data Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasPercentOfSystemCongested
     */
     
    public Collection<? extends Object> getHasPercentOfSystemCongested() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASPERCENTOFSYSTEMCONGESTED, Object.class);
    }

    public boolean hasHasPercentOfSystemCongested() {
		return !getHasPercentOfSystemCongested().isEmpty();
    }

    public void addHasPercentOfSystemCongested(Object newHasPercentOfSystemCongested) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASPERCENTOFSYSTEMCONGESTED, newHasPercentOfSystemCongested);
    }

    public void removeHasPercentOfSystemCongested(Object oldHasPercentOfSystemCongested) {
		getDelegate().removePropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASPERCENTOFSYSTEMCONGESTED, oldHasPercentOfSystemCongested);
    }


    /* ***************************************************
     * Data Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasPercentOfSystemCongested.id
     */
     
    public Collection<? extends Integer> getHasPercentOfSystemCongested.id() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASPERCENTOFSYSTEMCONGESTED.ID, Integer.class);
    }

    public boolean hasHasPercentOfSystemCongested.id() {
		return !getHasPercentOfSystemCongested.id().isEmpty();
    }

    public void addHasPercentOfSystemCongested.id(Integer newHasPercentOfSystemCongested.id) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASPERCENTOFSYSTEMCONGESTED.ID, newHasPercentOfSystemCongested.id);
    }

    public void removeHasPercentOfSystemCongested.id(Integer oldHasPercentOfSystemCongested.id) {
		getDelegate().removePropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASPERCENTOFSYSTEMCONGESTED.ID, oldHasPercentOfSystemCongested.id);
    }
