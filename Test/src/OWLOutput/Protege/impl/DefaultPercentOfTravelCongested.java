 ...
 * Source Class: DefaultPercentOfTravelCongested <br>
 * @version generated on Mon Mar 06 21:12:31 MST 2017 by danielmejia
 */
public class DefaultPercentOfTravelCongested extends WrappedIndividualImpl implements PercentOfTravelCongested {

    public DefaultPercentOfTravelCongested(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
    }
    ...
    /* ***************************************************
     * Data Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasPercentOfTravelCongested
     */
     
    public Collection<? extends Object> getHasPercentOfTravelCongested() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASPERCENTOFTRAVELCONGESTED, Object.class);
    }

    public boolean hasHasPercentOfTravelCongested() {
		return !getHasPercentOfTravelCongested().isEmpty();
    }

    public void addHasPercentOfTravelCongested(Object newHasPercentOfTravelCongested) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASPERCENTOFTRAVELCONGESTED, newHasPercentOfTravelCongested);
    }

    public void removeHasPercentOfTravelCongested(Object oldHasPercentOfTravelCongested) {
		getDelegate().removePropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASPERCENTOFTRAVELCONGESTED, oldHasPercentOfTravelCongested);
    }


    /* ***************************************************
     * Data Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasPercentOfTravelCongested.id
     */
     
    public Collection<? extends Integer> getHasPercentOfTravelCongested.id() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASPERCENTOFTRAVELCONGESTED.ID, Integer.class);
    }

    public boolean hasHasPercentOfTravelCongested.id() {
		return !getHasPercentOfTravelCongested.id().isEmpty();
    }

    public void addHasPercentOfTravelCongested.id(Integer newHasPercentOfTravelCongested.id) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASPERCENTOFTRAVELCONGESTED.ID, newHasPercentOfTravelCongested.id);
    }

    public void removeHasPercentOfTravelCongested.id(Integer oldHasPercentOfTravelCongested.id) {
		getDelegate().removePropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASPERCENTOFTRAVELCONGESTED.ID, oldHasPercentOfTravelCongested.id);
    }
