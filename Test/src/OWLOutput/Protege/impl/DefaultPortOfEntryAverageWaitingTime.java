 ...
 * Source Class: DefaultPortOfEntryAverageWaitingTime <br>
 * @version generated on Mon Mar 06 21:12:31 MST 2017 by danielmejia
 */
public class DefaultPortOfEntryAverageWaitingTime extends WrappedIndividualImpl implements PortOfEntryAverageWaitingTime {

    public DefaultPortOfEntryAverageWaitingTime(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
    }
    ...
    /* ***************************************************
     * Object Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#isPartOf
     */
    ...
    /* ***************************************************
     * Data Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasPOE.Minutes
     */
     
    public Collection<? extends String> getHasPOE.Minutes() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASPOE.MINUTES, String.class);
    }

    public boolean hasHasPOE.Minutes() {
		return !getHasPOE.Minutes().isEmpty();
    }

    public void addHasPOE.Minutes(String newHasPOE.Minutes) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASPOE.MINUTES, newHasPOE.Minutes);
    }

    public void removeHasPOE.Minutes(String oldHasPOE.Minutes) {
		getDelegate().removePropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASPOE.MINUTES, oldHasPOE.Minutes);
    }


    /* ***************************************************
     * Data Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasPOE.id
     */
     
    public Collection<? extends Integer> getHasPOE.id() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASPOE.ID, Integer.class);
    }

    public boolean hasHasPOE.id() {
		return !getHasPOE.id().isEmpty();
    }

    public void addHasPOE.id(Integer newHasPOE.id) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASPOE.ID, newHasPOE.id);
    }

    public void removeHasPOE.id(Integer oldHasPOE.id) {
		getDelegate().removePropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASPOE.ID, oldHasPOE.id);
    }


    /* ***************************************************
     * Data Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasPOEYsletaBridge.id
     */
     
    public Collection<? extends Integer> getHasPOEYsletaBridge.id() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASPOEYSLETABRIDGE.ID, Integer.class);
    }

    public boolean hasHasPOEYsletaBridge.id() {
		return !getHasPOEYsletaBridge.id().isEmpty();
    }

    public void addHasPOEYsletaBridge.id(Integer newHasPOEYsletaBridge.id) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASPOEYSLETABRIDGE.ID, newHasPOEYsletaBridge.id);
    }

    public void removeHasPOEYsletaBridge.id(Integer oldHasPOEYsletaBridge.id) {
		getDelegate().removePropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASPOEYSLETABRIDGE.ID, oldHasPOEYsletaBridge.id);
    }
