 ...
 * Source Class: DefaultTollRevenue <br>
 * @version generated on Mon Mar 06 21:12:31 MST 2017 by danielmejia
 */
public class DefaultTollRevenue extends WrappedIndividualImpl implements TollRevenue {

    public DefaultTollRevenue(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
    }
    ...
    /* ***************************************************
     * Data Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasTollRevenue.Value
     */
     
    public Collection<? extends Object> getHasTollRevenue.Value() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASTOLLREVENUE.VALUE, Object.class);
    }

    public boolean hasHasTollRevenue.Value() {
		return !getHasTollRevenue.Value().isEmpty();
    }

    public void addHasTollRevenue.Value(Object newHasTollRevenue.Value) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASTOLLREVENUE.VALUE, newHasTollRevenue.Value);
    }

    public void removeHasTollRevenue.Value(Object oldHasTollRevenue.Value) {
		getDelegate().removePropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASTOLLREVENUE.VALUE, oldHasTollRevenue.Value);
    }


    /* ***************************************************
     * Data Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasTollRevenue.id
     */
     
    public Collection<? extends Integer> getHasTollRevenue.id() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASTOLLREVENUE.ID, Integer.class);
    }

    public boolean hasHasTollRevenue.id() {
		return !getHasTollRevenue.id().isEmpty();
    }

    public void addHasTollRevenue.id(Integer newHasTollRevenue.id) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASTOLLREVENUE.ID, newHasTollRevenue.id);
    }

    public void removeHasTollRevenue.id(Integer oldHasTollRevenue.id) {
		getDelegate().removePropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASTOLLREVENUE.ID, oldHasTollRevenue.id);
    }
