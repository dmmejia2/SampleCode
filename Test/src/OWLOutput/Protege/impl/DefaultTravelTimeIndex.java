 ...
 * Source Class: DefaultTravelTimeIndex <br>
 * @version generated on Mon Mar 06 21:12:32 MST 2017 by danielmejia
 */
public class DefaultTravelTimeIndex extends WrappedIndividualImpl implements TravelTimeIndex {

    public DefaultTravelTimeIndex(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
    }
    ...
    /* ***************************************************
     * Data Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasTravelTimeIndex.Value
     */
     
    public Collection<? extends Object> getHasTravelTimeIndex.Value() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASTRAVELTIMEINDEX.VALUE, Object.class);
    }

    public boolean hasHasTravelTimeIndex.Value() {
		return !getHasTravelTimeIndex.Value().isEmpty();
    }

    public void addHasTravelTimeIndex.Value(Object newHasTravelTimeIndex.Value) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASTRAVELTIMEINDEX.VALUE, newHasTravelTimeIndex.Value);
    }

    public void removeHasTravelTimeIndex.Value(Object oldHasTravelTimeIndex.Value) {
		getDelegate().removePropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASTRAVELTIMEINDEX.VALUE, oldHasTravelTimeIndex.Value);
    }


    /* ***************************************************
     * Data Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasTravelTimeIndex.id
     */
     
    public Collection<? extends Integer> getHasTravelTimeIndex.id() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASTRAVELTIMEINDEX.ID, Integer.class);
    }

    public boolean hasHasTravelTimeIndex.id() {
		return !getHasTravelTimeIndex.id().isEmpty();
    }

    public void addHasTravelTimeIndex.id(Integer newHasTravelTimeIndex.id) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASTRAVELTIMEINDEX.ID, newHasTravelTimeIndex.id);
    }

    public void removeHasTravelTimeIndex.id(Integer oldHasTravelTimeIndex.id) {
		getDelegate().removePropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASTRAVELTIMEINDEX.ID, oldHasTravelTimeIndex.id);
    }
