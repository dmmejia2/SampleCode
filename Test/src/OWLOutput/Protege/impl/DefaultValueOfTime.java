 ...
 * Source Class: DefaultValueOfTime <br>
 * @version generated on Mon Mar 06 21:12:32 MST 2017 by danielmejia
 */
public class DefaultValueOfTime extends WrappedIndividualImpl implements ValueOfTime {

    public DefaultValueOfTime(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
    }
    ...
    /* ***************************************************
     * Object Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#costOf
     */
     
    public Collection<? extends TravelTime> getCostOf() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_COSTOF,
                                               DefaultTravelTime.class);
    }

    public boolean hasCostOf() {
	   return !getCostOf().isEmpty();
    }

    public void addCostOf(TravelTime newCostOf) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_COSTOF,
                                       newCostOf);
    }

    public void removeCostOf(TravelTime oldCostOf) {
    ...
    /* ***************************************************
     * Data Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasValueOfTime.Value
     */
     
    public Collection<? extends Object> getHasValueOfTime.Value() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASVALUEOFTIME.VALUE, Object.class);
    }

    public boolean hasHasValueOfTime.Value() {
		return !getHasValueOfTime.Value().isEmpty();
    }

    public void addHasValueOfTime.Value(Object newHasValueOfTime.Value) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASVALUEOFTIME.VALUE, newHasValueOfTime.Value);
    }

    public void removeHasValueOfTime.Value(Object oldHasValueOfTime.Value) {
		getDelegate().removePropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASVALUEOFTIME.VALUE, oldHasValueOfTime.Value);
    }


    /* ***************************************************
     * Data Property http://anonymous.org/resource/fpFreighPerformanceMetrics.owl#hasValueOfTime.id
     */
     
    public Collection<? extends Integer> getHasValueOfTime.id() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASVALUEOFTIME.ID, Integer.class);
    }

    public boolean hasHasValueOfTime.id() {
		return !getHasValueOfTime.id().isEmpty();
    }

    public void addHasValueOfTime.id(Integer newHasValueOfTime.id) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASVALUEOFTIME.ID, newHasValueOfTime.id);
    }

    public void removeHasValueOfTime.id(Integer oldHasValueOfTime.id) {
		getDelegate().removePropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASVALUEOFTIME.ID, oldHasValueOfTime.id);
    }
